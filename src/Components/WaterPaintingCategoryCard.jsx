...
const WaterPaintingCategoryCard = ({data}) => {
    const { image, item, description, _id, price, category, rating, time } = data;
    return (
        <div>
             <Helmet>
                <title>Awasome Craft Store | Water painting Category Card</title>
            </Helmet>
...
WaterPaintingCategoryCard.propTypes = {
    data: PropTypes.object.isRequired
  };

export default WaterPaintingCategoryCard;