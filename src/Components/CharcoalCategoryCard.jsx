...
const CharcoalCategoryCard = ({data}) => {
    const { image, item, description, _id,category, price,rating, time } = data;
    return (
        <div>
             <Helmet>
                <title>Awasome Craft Store | Charcoal drawing Category Card</title>
            </Helmet>
...
CharcoalCategoryCard.propTypes = {
    data: PropTypes.object.isRequired,
  };

export default CharcoalCategoryCard;