...
const PortaitCategoryCard = ({data}) => {
    const { image, item, description, _id, price, category, rating, time } = data;
    return (
        <div>
             <Helmet>
                <title>Awasome Craft Store | portait drawing Category Card</title>
            </Helmet>
...
PortaitCategoryCard.propTypes = {
    data: PropTypes.object.isRequired
  };

export default PortaitCategoryCard;