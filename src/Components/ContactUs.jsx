    ...
    return (
        <div id="contact">
            ...
            <div className="text-center mt-10">
                ...
                <p className=" md:w-[500px] lg:w-[700px] mx-auto text-base-content">Awasome Craft Store company Where colors meet convenience. Reach our expert team for tailored advice, product inquiries, and seamless service. Let us paint your dreams together! <br /> <span className="text-rose-600">If you feel free please send your feedback.</span></p>
            </div>
